...
<div class="tabs">
	...
	<h2 onclick="tabToggle(1);" id="tab2_h2"><a href="#" id="tab2_h2_a">Subscribe</a></h2>
				...
				<div class="con2_1">
						...
						<div class="con2_2">
							<table border="0" cellspacing="5" cellpadding="5">
								...
								<tr>
									...
									<td>
										<input id="cb1" type="checkbox" <?php if(isset($_SESSION["game"])) echo $_SESSION["game"]; ?>  name="game" value="Football" /><span>Games</span> &nbsp;&nbsp;
										<input id="cb2" type="checkbox" <?php if(isset($_SESSION["movie"])) echo $_SESSION["movie"]; ?>  name="movie" value="Movie" /><span>Movie</span> &nbsp;&nbsp;
										<input id="cb3" type="checkbox" <?php if(isset($_SESSION["reading"])) echo $_SESSION["reading"]; ?>  name="reading" value="Reading" /><span>Reading</span> &nbsp;&nbsp;	
									</td>
								</tr>
							</table>
						</div><!-- end of con2_2 -->
							...
							<table  cellspacing="5" cellpadding="5">
								...
								<tr>
									...
									<td>
									 ...
									 <option value="<?php if( isset($_SESSION['stateErr']) && empty($_SESSION['stateErr'])) { echo $_SESSION['state'];} ?>"  <?php if( isset($_SESSION['stateErr']) && empty($_SESSION['stateErr'])) { echo "selected";} ?>   > <?php if( isset($_SESSION["stateErr"]) && empty($_SESSION["stateErr"])) { echo $_SESSION["state"]; } ?> </option>  
						...
						<input type="submit" class="subscribe" name="submit"  title="Click me to subscribe" value ="Subscribe"  />
				</div> <!-- end of con2_1 -->
	</div> <!-- end of tab2  -->
...
<?php
    ...
    $_SESSION["game"] = $_SESSION["movie"] = $_SESSION["reading"] = "";
?>
